...
export default function ChatBuyerHeader() {
  return (
    <div className="w-full bg-[#101010] border-b border-gray-800">
      {/* 상단 LV/이름 라인 */}
      ...
      <div className="px-4 pb-4">
        ...
        <button className="mt-1 bg-gray-800 text-white text-sm font-semibold px-3 py-1 rounded flex items-center gap-1">
